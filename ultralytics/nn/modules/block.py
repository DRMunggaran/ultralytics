...
class ResBlock(nn.Module):
    def __init__(self, in_channels, out_channels=None, stride=1):
        ...
        if out_channels is None:
            out_channels = in_channels  # default same channels
...
class GlobalAttention(nn.Module):
    ...
    def __init__(self, in_channels, reduction_ratio=4):
        ...
        self.spatial_conv = nn.Sequential(
            nn.Conv2d(in_channels, reduced, 7, padding=3, bias=False),
            nn.BatchNorm2d(reduced),
            nn.SiLU(inplace=True),
            nn.Conv2d(reduced, in_channels, 7, padding=3, bias=False),
...
# ── Combined: ResBlock + Global Attention ────────────────────────────────────
class ResBlockWithAttention(nn.Module):
    def __init__(self, in_channels, out_channels=None):
        ...
        self.attn = GlobalAttention(out_channels)
